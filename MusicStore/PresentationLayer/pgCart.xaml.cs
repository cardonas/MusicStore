...
namespace PresentationLayer
{
    ...
    public partial class PgCart
    {
        ...
        public PgCart(Employee user, Customer customer = null, bool customerAdded = false)
        {
            InitializeComponent();
        ...
        private void AutoComplete_AutoGeneratedColumns(object sender, EventArgs e)
        {
        ...
        {
            this.NavigationService?.Navigate(new pgCustomerDetails( true, true, _user));
        }
